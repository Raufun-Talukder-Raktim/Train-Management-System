 ...
 * @author USER C
 */
public class CurrentAmount extends javax.swing.JFrame {
    ...
    public CurrentAmount(String PresentAmount , String User_Name , String AccountNo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Money has been returned");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, -1, 50));
    ...
    private void OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKActionPerformed
        ...
        new ThankYou(User_Name , AccountNo).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CurrentAmount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CurrentAmount().setVisible(true);
            }
        });
    }
