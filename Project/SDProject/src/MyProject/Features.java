...
public class Features extends javax.swing.JFrame {
    ...
    public Features(String User_Name , String AccountNo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 60, -1, 30));

        jLabel1.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 22)); // NOI18N
        jLabel1.setText("• All the information about any particular train . ");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 520, 50));
        ...
        jLabel2.setText("• Purchasing ticket normally or emergency . ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 510, 50));

        jLabel5.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 22)); // NOI18N
        jLabel5.setText("• Cancelling the purchased ticket . ");
        ...
        jLabel6.setText("• Providing any suggestion or any objection to the authority .");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 380, 670, 50));
